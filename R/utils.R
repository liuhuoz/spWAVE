...
generate_kmeans_coord <- function(
  ...
  km_coord <- coord %>%
    ...
    as.data.frame()
  return(list(meta=km_coord,single_coord=coord))
}
...
#'
#' @param meta_coord_list The meta coordinates list. 
